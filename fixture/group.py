...
class GroupHelper:
    ...
    def ensure_open_groups_page(self):
        wd = self.app.wd
        if not len(wd.find_elements_by_xpath("// *[@id ='content'] / h1[. = 'Groups']")) > 0:
    ...
    def prepare_groups(self):
        ...
        self.open_groups_page()
        if not self.count() > 0:
            self.create(Group(groupname="prepare", groupheader="prepare", groupfooter="prepare"))
